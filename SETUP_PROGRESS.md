...
### 🛑 หยุดพัก
- **ครั้งหน้า**: ทำต่อ 3 หน้าวิชา (by-subject/score-structure/activities)
  เลือกชั้น/ห้อง/วิชาก่อน (pattern ข้อ 8 + subject layer: วิชาเดียว auto/
  หลายวิชา dropdown · by-subject ต้อง guard-early ก่อน offering-fetch)
- commit ล่าสุด: `63ac049` · pushed
- หลัง deploy: ทดสอบ print → Save PDF → ชื่อควรเป็น "&lt;งาน&gt; ป.X[ ห้อง Y]
  ภาคเรียนที่ N ปีการศึกษา YYYY"
